...
const char MQTTSTRING[] = "{\"d\":{\"myName\":\"TILaunchPad\",\"X\":%i,\"Y\":%i,\"Z\":%i,\"RSSI\":%i}}";
...
void loop() {
  ...
  sprintf(string, MQTTSTRING, accSensor.readXData(), accSensor.readYData(),accSensor.readZData(),-WiFi.RSSI());
